...
Solutions for [Python with benchmarks](./python/README.md)
...
| [Day 6](./src/bin/06.rs) | `658.2µs` | `47.5ms` |
| [Day 7](./src/bin/07.rs) | `2.4ms` | `83.0ms` |
| [Day 8](./src/bin/08.rs) | `45.9µs` | `449.9µs` |
| [Day 11](./src/bin/11.rs) | `267.8µs` | `14.9ms` |
| [Day 12](./src/bin/12.rs) | `8.4ms` | `-` |
| [Day 15](./src/bin/15.rs) | `790.4µs` | `-` |
| [Day 16](./src/bin/16.rs) | `14.8ms` | `22.0ms` |
| [Day 17](./src/bin/17.rs) | `2.2µs` | `-` |
